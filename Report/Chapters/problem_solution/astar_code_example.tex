...
\lstinputlisting[style=customc, language=C, firstline=23, lastline=41, caption={Allocations in function AStar}, label=list:astar_allocate]{../Program/Sources/astar.c}
...
\lstinputlisting[style=customc, language=C, firstline=148, lastline=201, caption={Get neighbours function}, label=list:get_neighbours]{../Program/Sources/astar.c}
