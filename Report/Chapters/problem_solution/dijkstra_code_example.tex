...
\lstinputlisting[style=customc, language=C, firstline=15, lastline=36, caption={WorkVertex and the its linked list}, label=list:djstruct]{../Program/Sources/dijkstra.c}
