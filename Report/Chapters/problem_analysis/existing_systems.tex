...
Maps are for the mostly easy to use and serves as a great tool when arriving at a new location as they give the user a quick overview on the location.
...
\subsection{Porter}
The porter helps patients and visitors get around at the hospital. The porter helps visitors find available beds if they have to stay at the hospital overnight \cite{ugd_port}. An employee would probably be able to navigate at their working place with ease.
