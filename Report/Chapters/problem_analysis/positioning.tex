...
\sinote{Overvej om positionering skal med i teori, da vi ikke kommer til at beskæftige os med dette i løsningen.}
\subsection{Positioning}\label{sub:pos}
 ...
 \subsubsection{Lateration}
  ...
  Lateration is a commonly used technique for positioning.  Lateration uses the distance between known locations and and the point to be determined, to estimate the location.\cite{tri_lateration}  There are two types of lateration two dimensional and three dimensional. The two dimensional are use in robots that navigates in only one plane, like robot vacuum cleaners. 
