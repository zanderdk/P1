...
\subsection{Positioning Techniques}
 ...
 \subsubsection{Lateration}
  ...
  We will only explain three dimensional lateration. \sinote{i figuren, mangler rigtig kilde?}
  \begin{figure}[ht!]
  \centering
  ...
  This is illustrated as the blue circle on figure \ref{fig:trilateration} \sinote{brug evt. cref og slet figure. magic happens}, and is the intersection between sphere A and B.
